      ...
      <div className="max-w-5xl mx-auto rounded-[3rem] bg-gradient-to-br from-card to-white/5 border border-white/10 p-8 md:p-16 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8">
            ...
            <h2 className="text-5xl font-black font-headline tracking-tighter leading-none">Built by a Student, <br /> For Students.</h2>
            <div className="space-y-4 text-muted-foreground text-lg leading-relaxed">
              <p>
                <strong>Louis Da Vinci</strong> founded School's DIY Hub at age 15 with a simple vision: Every student deserves a laboratory to build the future.
              </p>
              <p>
                Starting in Uganda, we are scaling across Africa to the world, empowering the next generation of creative engineers.
              </p>
            </div>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-2 text-xs font-bold text-primary bg-primary/5 px-4 py-2 rounded-full border border-primary/20">
                <Award className="h-4 w-4" /> Verified Innovator Profile
              </div>
            </div>
          </div>
