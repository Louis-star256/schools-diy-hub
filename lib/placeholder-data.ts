...
export const demoUsers: User[] = [
  {
    id: 'demo-user-1',
    fullName: 'Louis Da Vinic',
    email: 'louis@diyhub.demo',
    profilePicture: 'https://i.imgur.com/3Yay8aW.jpeg',
    levelOfStudies: 'Senior 2',
    bio: 'Creator of School\'s DIY Hub. I love building robots and solving community problems with code.',
