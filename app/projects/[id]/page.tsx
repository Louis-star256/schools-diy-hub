    ...
    <div className="container mx-auto px-4 py-8 md:px-6 md:py-12 max-w-7xl">
      ...
      <article className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <aside className="space-y-10">
          ...
          {school && (
             <Card className="rounded-[3rem] border-2 border-accent/40 overflow-hidden shadow-2xl bg-card">
                <div className="relative h-40 w-full">
                    ...
                    <div className="absolute bottom-6 left-8 flex items-center gap-4">
                         <div className="h-12 w-12 rounded-full bg-accent/30 flex items-center justify-center border border-accent shadow-xl backdrop-blur-md">
                            <MapPin className="h-6 w-6 text-accent" />
                         </div>
                         <h3 className="font-headline font-bold text-2xl leading-tight text-white tracking-tight">{school.name}</h3>
                    </div>
                </div>
                <CardContent className="p-8 pt-4 space-y-6">
                    <p className="text-sm text-white/80 leading-relaxed font-medium">
                        This innovation is backed by <strong>{school.name}</strong>, a verified {school.type} in {school.country || 'Uganda'}.
                    </p>
                    <div className="flex flex-col gap-3">
                         <Button className="w-full gap-2 rounded-2xl h-14 text-lg font-headline shadow-xl shadow-accent/20" variant="secondary" asChild>
                            <Link href="/institutions">
                                <Globe className="h-5 w-5" /> View on Hub Map
                            </Link>
                         </Button>
                    </div>
                </CardContent>
